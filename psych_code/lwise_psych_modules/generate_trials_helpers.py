...
def get_choice_names_and_urls(block_config, trial_config, class_to_url_dict):
  ...
  if "shuffle_choice_order" in block_config and block_config["shuffle_choice_order"]:
    ...
    if "rotate_choice_order" in block_config and block_config["rotate_choice_order"]:
