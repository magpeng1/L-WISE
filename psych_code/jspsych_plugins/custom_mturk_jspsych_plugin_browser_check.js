  ...
  ***************************************************************************** */
  ...
  class BrowserCheckPlugin {
      ...
      end_trial(feature_data) {
          this.jsPsych.getDisplayElement().innerHTML = "Checking browser configuration. Please wait.";
          const trial_data = Object.assign({}, Object.fromEntries(feature_data));
          this.jsPsych.finishTrial(trial_data);
      }
      end_experiment(feature_data) {
          // This is the only part modified by Morgan - it displays a message permanently instead of auto-submitting the HIT
          const trial_data = Object.assign({}, Object.fromEntries(feature_data));
          this.jsPsych.getDisplayElement().innerHTML = this.t.exclusion_message(trial_data);
