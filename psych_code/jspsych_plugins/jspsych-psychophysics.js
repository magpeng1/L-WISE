...
var jsPsychPsychophysics = (function (jspsych) {
  ...
  class PsychophysicsPlugin {
    ...
    trial(display_element, trial) {
      ...
      // Dispose function to remove all attached event listeners
      const dispose = () => {
        window.cancelAnimationFrame(frameRequestID); //Cancels the frame request
        canvas.removeEventListener("mousedown", mouseDownFunc);
        ...
        // Dispose any resources held by stimuli in trial.stim_array if needed
        if (trial.stim_array) {
            trial.stim_array.forEach(stim => {
      ...
      trial.funcs = trial.funcs || {}; 
      trial.funcs.dispose = dispose;
