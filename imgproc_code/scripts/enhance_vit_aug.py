...
def get_args(argv):
    ...
    parser.add_argument('--arch', type=str, default='resnet50', required=False, help="Name of the architecture. resnet50 | vit")
    ...
    parser.add_argument('--from_tf_harmonized', default=False, action='store_true', help="Add this flag if you are using harmonized ViT")
