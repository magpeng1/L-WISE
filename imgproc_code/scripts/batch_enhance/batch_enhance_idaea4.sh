...
DATASET_NAME_RB="idaea4"  # This is the name of the dataset as seen in the robustness library (e.g., ImageNet)
DATASET_NAME="idaea4"  # This is the name of the dataset as we will actually name it (e.g., imagenet16)
DATASET_PATH="/home/morgan/projects/learn-histopath-backend/data/idaea4"
DIRMAP_CSV_PATH="/home/morgan/projects/learn-histopath-backend/data/idaea4/dirmap.csv"
MODEL_PATH="model_ckpts/idaea4_eps1.pt"
